...
function getClientOptions(): LanguageClientOptions {
    return {
        documentSelector: [
            { scheme: "file", language: "impcore" },
            { scheme: "untitled", language: "impcore" },
        ],
        outputChannelName: "[pygls] 105LanguageServer",
        synchronize: {
...
export function activate(context: ExtensionContext): void {
    ...
    // } else {
        ...
        // const cwd = path.join(__dirname, "..", "..", "language-server");
        ...
        // client = startLangServer(pythonPath, ["-m", "plls"], cwd);
